        ...
        public LoginResultModel UserAuthenticate(LoginModel model)
        {
            ...
            using (SqlConnection conn = new SqlConnection(DBCon))
            {
                ...
                while (reader.Read())
                {
                    ...
                    __LoginResultModel.Lastname = reader["Lastname"].ToString();
        ...
        public DashboardModels DashboardStats()
        {
            ...
            using (SqlConnection conn = new SqlConnection(DBCon))
            {
                ...
                while (reader.Read())
                {
                    ...
                    _DashboardModels.PoSummaryList = reader["PoSummaryList"].ToString();
                    ...
                    _DashboardModels.ArchivedRawMaterials = reader["ArchivedRawMaterials"].ToString();
                    _DashboardModels.ReceivedRawMaterials = reader["ReceivedRawMaterials"].ToString();
                    _DashboardModels.MacroRawMaterials = reader["MacroRawMaterials"].ToString();
                    _DashboardModels.RejectRawMaterials = reader["RejectRawMaterials"].ToString();
                    _DashboardModels.VendorList = reader["VendorList"].ToString();
                }
