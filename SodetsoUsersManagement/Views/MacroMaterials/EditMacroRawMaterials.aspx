...
<%--                                   <fieldset id="group80" class="radio-inline">
                <input type="radio" name="rej_data1" value="Approved" checked>
                &#10004;

                <input type="radio" name="rej_data1" value="DisApproved">&#967;
             </fieldset>--%>
    ...
    <!-- Sample code here scripting -->
                    ...
                    <td colspan="2" style="text-align:center">                                            
              <%--                     <fieldset id="group81" class="radio-inline">
                <input type="radio" name="rej_data2" value="Approved" id="myRadio">
                &#10004;

  <%: Html.RadioButtonFor(model => model.rej_data2, new { @class = "form-control requiredfilled",@type="radio"}) %>
     <%: Html.ValidationMessageFor(model => model.rej_data2, "", new { @class = "text-danger" }) %>

                <input type="radio" name="rej_data2" value="DisApproved">&#967;
             </fieldset>--%>
              ...
              <%: @Html.ValidationMessageFor(model => model.rej_data2, "", new { @class = "text-danger" }) %>
                    ...
                    <td colspan="2" style="text-align:center">                                            
                   <%--                <fieldset id="group82" class="radio-inline">
                <input type="radio" name="rej_data3" value="Approved" checked>
                &#10004;

                <input type="radio" name="rej_data3" value="DisApproved">&#967;
             </fieldset>--%>
              ...
              <%: @Html.ValidationMessageFor(model => model.rej_data3, "", new { @class = "text-danger" }) %>
                    ...
                    <td colspan="2" style="text-align:center">                                            
                               <%--    <fieldset id="group83" class="radio-inline">
                <input type="radio" name="rej_data4" value="Approved" checked>
                &#10004;

                <input type="radio" name="rej_data4" value="DisApproved">&#967;
             </fieldset>--%>
              ...
              <%: @Html.ValidationMessageFor(model => model.rej_data4, "", new { @class = "text-danger" }) %>
                ...
                <tr>
                    ...
                    <td colspan="2" style="text-align:center">                                            
<%--                                   <fieldset id="group85" class="radio-inline">
                <input type="radio" name="rej_data6" value="Approved" checked>
                &#10004;

                <input type="radio" name="rej_data6" value="DisApproved">&#967;
             </fieldset>--%>
              ...
              <%: @Html.ValidationMessageFor(model => model.rej_data6, "", new { @class = "text-danger" }) %>
               ...
               <tr>
                    ...
                    <td colspan="2" style="text-align:center">                                            
<%--                                   <fieldset id="group86" class="radio-inline">
                <input type="radio" name="rej_data7" value="Approved" checked>
                &#10004;

                <input type="radio" name="rej_data7" value="DisApproved">&#967;
             </fieldset>--%>
...
<%--    //5 data start here with unregistered model--%>

    
                    <tr>
                    <td>No signs of tampering</td>
                    <td>                                            
      <%--                             <fieldset id="group5" class="radio-inline">
                <input type="radio" name="truck_approval5" value="Approved" checked>
                &#10004;
    
  
                <input type="radio" name="truck_approval5" value="DisApproved">&#967;
             </fieldset>--%>
      ...
      <%: Html.ValidationMessageFor(model => model.truck_remarks5, "", new { @class = "text-danger" }) %>
                    ...
                    <td>                                            
                                 <%--  <fieldset id="group6" class="radio-inline">
                <input type="radio" name="truck_approval6" value="Approved" checked>
                &#10004;
    
  
                <input type="radio" name="truck_approval6" value="DisApproved">&#967;
             </fieldset>--%>
      ...
      <%: Html.ValidationMessageFor(model => model.truck_remarks6, "", new { @class = "text-danger" }) %>
                    ...
                    <td>                                            
   <%--                                <fieldset id="group7" class="radio-inline">
                <input type="radio" name="truck_approval7" value="Approved" checked>
                &#10004;
    
  
                <input type="radio" name="truck_approval7" value="DisApproved">&#967;
             </fieldset>--%>
      ...
      <%: Html.ValidationMessageFor(model => model.truck_remarks7, "", new { @class = "text-danger" }) %>
                    ...
                    <td>                                            
<%--                                   <fieldset id="group8" class="radio-inline">
                <input type="radio" name="truck_approval8" value="Approved" checked>
                &#10004;
    
  
                <input type="radio" name="truck_approval8" value="DisApproved">&#967;
             </fieldset>--%>
      ...
      <%: Html.ValidationMessageFor(model => model.truck_remarks8, "", new { @class = "text-danger" }) %>
                    ...
                    <td>                                            
                                   <%--<fieldset id="group9" class="radio-inline">
                <input type="radio" name="truck_approval9" value="Approved" checked>
                &#10004;
    
  
                <input type="radio" name="truck_approval9" value="DisApproved">&#967;
             </fieldset>--%>
      ...
      <%: Html.ValidationMessageFor(model => model.truck_remarks9, "", new { @class = "text-danger" }) %>
                    ...
                    <td>No evidence of chemical spills, garbage, waste or spoiled foods</td>
                    <td>                                            
                               <%--    <fieldset id="group10" class="radio-inline">
                <input type="radio" name="truck_approval10" value="Approved" checked>
                &#10004;
    
  
                <input type="radio" name="truck_approval10" value="DisApproved">&#967;
             </fieldset>--%>
      ...
      <%: Html.ValidationMessageFor(model => model.truck_remarks_all, "", new { @class = "text-danger" }) %>
       ...
       <%--          <td>--%>
<%--                       <%: Html.TextBoxFor(model => model.truck_remarks_all, new { @class = "form-control requiredfilled", @placeholder="Required", @required ="true",@autocomplete="off"}) %>
      <%: Html.ValidationMessageFor(model => model.truck_remarks_all, "", new { @class = "text-danger" }) %>--%>
