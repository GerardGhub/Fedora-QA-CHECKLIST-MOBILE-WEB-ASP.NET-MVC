...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
     <%: ViewBag.PageTitle =" Feed Mill Reject Raw Materials Partial Receiving" %> 
</asp:Content>
                    ...
                    <table id="example1" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                               ...
                               <td><%: Html.DisplayFor(m => item.qty_reject) %></td>
                             ...
                             <td>
                                    <a class="btn btn-xs btn-primary" href="/QAPoSummaryCheck/EditPoRejection/<%: Html.DisplayFor(m => item.po_sum_id) %>"><i class="fa fa-edit"></i></a>
