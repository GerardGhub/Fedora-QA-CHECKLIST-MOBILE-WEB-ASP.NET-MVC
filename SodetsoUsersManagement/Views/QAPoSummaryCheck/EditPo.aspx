...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="col-md-6">
            ...
            <% } %>
             ...
             <td>                     <%: Html.TextBoxFor(model => model.pr_date, new { @class = "form-control", @placeholder="Enter PR Date", ReadOnly="true"}) %></td>
                        ...
                        <input type="text" id="ActualRemaining" value="<%: Model.qty_remarks%>" class="form-control" readonly />
    ...
    <script>
        ...
        $(function () {
            $("#num1, #ActualDelivered, #num3, #num4, #subt,#master1, #master2,#ten, #expected, #reject, #OrderVsGood, #reject1, #reject2, #ActualRemaining").on("keydown keyup", sum);
            function sum() {
                ...
                $("#tenPercentComputationChange").val(1.10 * Number($("#ActualRemaining").val().replace(/,/g, '')));
            ...
            if (confirm(datediff(parseDate(dateToday.value), parseDate(master2.value)) + " Days Between Mfg.Date And Expiry Date Do you want to Proceed The Checklist ?")) {
                ...
                if (ActualDelivery < 10) {
                    ...
                    if (parseFloat($("#tenPercentComputation").val()) == parseFloat($("#ActualDelivered").val())) {
                        ...
                        if (parseFloat($("#num1").val()) == parseFloat($("#ActualRemaining").val())) {
                        ...
                        else
                        {
                            ...
                            if (parseFloat($("#tenPercentComputationChange").val()) > parseFloat($("#ActualDelivered").val())) {
                                ...
                                if (parseFloat($("#tenPercentComputationChange").val()) == parseFloat($("#ActualDelivered").val())) {
                                    ...
                                    $(".error").css("display", "none");
                                    //$("#submit").prop('disabled', false);
                                    alert("Maximum 10 Percent Allowable Exceed 3!!");
                                    ($('#ActualDelivered').val(""));
