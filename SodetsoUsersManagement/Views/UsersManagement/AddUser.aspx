...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: ViewBag.PageTitle = "Add QA Checklist User" %>
</asp:Content>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">User Application Form</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <%: Html.TextBoxFor(model => model.Middlename, new { @class = "form-control", @placeholder="Enter Middlename",@required="true"}) %>
                                                    <%: Html.ValidationMessageFor(model => model.Middlename, "", new { @class = "text-danger" }) %>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Lastname</label>
                                <%: Html.TextBoxFor(model => model.Lastname, new { @class = "form-control", @placeholder="Enter Lastname",@required="true"}) %>
                                                    <%: Html.ValidationMessageFor(model => model.Middlename, "", new { @class = "text-danger" }) %>
                            </div>
                            <div class="form-group">
                                <label>Gender</label>
                            ...
                            <div class="form-group">
                                ...
                                <%: Html.TextBoxFor(model => model.Position, new { @class = "form-control", @placeholder="Enter Position",@required="true"}) %>
