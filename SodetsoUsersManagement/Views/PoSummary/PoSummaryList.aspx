<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Master.Master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<SodetsoUsersManagement.Models.PoSummaryListModel>>" %>


<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
  
       <%: ViewBag.PageTitle = "PO Summary List Report" %>
</asp:Content>
                            ...
                            <tr>
                                <td>
                                   <%-- <% if (item.Image == null)
                                    ...
                                    <%: Html.DisplayFor(m => item.pr_number) %>
                                </td>

                                <td style="font-size:12px;">
                                          <%: Html.DisplayFor(m => item.pr_date) %>
                                    <%--<%: Html.DisplayFor(m => item.Firstname) %> <%: Html.DisplayFor(m => item.Middlename) %> <%: Html.DisplayFor(m => item.Lastname) %>--%></td>
                                <td><%: Html.DisplayFor(m => item.po_number) %></td>
                                <td style="font-size:12px;"><%: Html.DisplayFor(m => item.po_date) %></td>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    { %>
                                                        <div class="modal-body">
                                                           Are you sure you want to deactivate the User <strong><%: Html.DisplayFor(m => item.item_code) %> <%: Html.DisplayFor(m => item.item_description) %> ></strong>?
                                    ...
                                    <div class="modal fade" id="ActivateUserModal<%: Html.DisplayFor(m => item.po_sum_id) %>" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                { %>
                                                    <div class="modal-body">
                                                        Are you sure you want to Activate the User <strong><%: Html.DisplayFor(m => item.item_code) %> <%: Html.DisplayFor(m => item.item_description) %></strong>?
                                                           
                                                        <input type="hidden" class="form-control" name="UserID" value="<%: Html.DisplayFor(m => item.po_sum_id) %>" />
                                ...
                                <td>
                                                                      <a class="btn btn-xs btn-primary" href="/PoSummary/EditPoSummary/<%: Html.DisplayFor(m => item.po_sum_id) %>"><i class="fa fa-edit"></i></a>
                                        ...
                                        <div class="modal fade" id="RemoveUser<%: Html.DisplayFor(m => item.po_sum_id) %>" tabindex="-1" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    { %>
                                                        <div class="modal-body">
                                                           Are you sure you want to remove the User <strong><%: Html.DisplayFor(m => item.item_code) %> <%: Html.DisplayFor(m => item.item_description) %> </strong>?
